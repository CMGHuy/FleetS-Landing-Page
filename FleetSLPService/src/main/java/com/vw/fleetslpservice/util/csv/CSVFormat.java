...
import static com.vw.fleetslpservice.util.csv.Constants.BACKSLASH;
import static com.vw.fleetslpservice.util.csv.Constants.COMMA;
import static com.vw.fleetslpservice.util.csv.Constants.COMMENT;
import static com.vw.fleetslpservice.util.csv.Constants.CR;
import static com.vw.fleetslpservice.util.csv.Constants.CRLF;
import static com.vw.fleetslpservice.util.csv.Constants.DOUBLE_QUOTE_CHAR;
import static com.vw.fleetslpservice.util.csv.Constants.EMPTY;
import static com.vw.fleetslpservice.util.csv.Constants.LF;
import static com.vw.fleetslpservice.util.csv.Constants.PIPE;
import static com.vw.fleetslpservice.util.csv.Constants.SP;
import static com.vw.fleetslpservice.util.csv.Constants.TAB;
...
public final class CSVFormat implements Serializable {
    ...
    public static final CSVFormat FLP = new CSVFormat(COMMA, null, null, null, null, false, true, CRLF,
    		null, null, null, false, false, false, false, false, false, true);
    ...
    public static final CSVFormat newFormatDelimeterDetect(final char delimiter) {
        return new CSVFormat(delimiter, DOUBLE_QUOTE_CHAR, null, null, null, false, true, CRLF,
                null, null, null, false, false, false, false, false, false, true);
    }
     ...
     */
    public CSVParser parse(final Reader in) throws IOException, FileValidationException {
